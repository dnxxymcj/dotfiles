...
M.set_colemak_keymaps = function()
  ...
  map("", "<C-s>", "<C-w>h", { noremap = true, silent = true })
  map("", "<C-t>", "<C-w>l", { noremap = true, silent = true })
  map("", "<C-n>", "<C-w>j", { noremap = true, silent = true })
  map("", "<C-e>", "<C-w>k", { noremap = true, silent = true })
